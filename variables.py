...
VALID_ADVANTAGES               = ["advanced intel","fortified position","cunning deployment","garrison","ordnance","strafing run"]
VALID_FACTIONS                 = ["rebel","empire","republic","separatist","shadow collective","galactic republic"]

DICT_EMOJI_LIGUES_DISPLAY      = {
    "kessel"                   :"🟢",
    "coruscant"                :"🔴",
    "alderaan"                 :"🔵",
    "tatooine"                 :"🟠"
